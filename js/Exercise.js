...
/* ESERCIZIO 4/5
  ...
  Ad ognuna di queste proprietà assegna come valore un array vuoto. successivamente--
...
/*let crewMass = 0;
let nPersonaggi = 0;
while (nPersonaggi < starWarsCharacters.length) {
  crewMass += crewMass + starWarsCharacters[nPersonaggi].mass;
  nPersonaggi++;
